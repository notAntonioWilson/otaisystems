...
const bookingLinks = {
  starter: 'https://cal.com/antonio-wilson-qfqybv/30min',
  professional: 'https://cal.com/antonio-wilson-qfqybv/30min-copy',
  enterprise: 'https://cal.com/antonio-wilson-qfqybv/30min-copy-copy',
};
