        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.55, ease: 'easeOut' }} className="glass-card rounded-2xl p-8 flex flex-col justify-between min-h-[340px]">
              ...
              <h3 className="text-xl font-bold text-white mb-3">More demos on YouTube.</h3>
              <p className="text-muted-foreground leading-[1.7] mb-6 text-sm">I drop new AI agent demos, builds, and breakdowns regularly. See more before booking a call.</p>
